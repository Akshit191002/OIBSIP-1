...
public class Quiz extends JFrame implements ActionListener
{
    ...
    Quiz(String name)
    {
        ...
        qn = new JLabel();
        qn.setBounds(100,400,50,30);
        qn.setFont(new Font("Tahoma",Font.PLAIN,24));
        add(qn);
        
        q = new JLabel();
        q.setBounds(150,400,900,30);
    ...
    public void actionPerformed(ActionEvent e)
    {
        if(e.getSource()==b1)
        {
            ...
            {
                user[count][0]=gp.getSelection().getActionCommand();
            }
            if(count==8)
            {
                b1.setEnabled(false);
        ...
        else
        {
            ...
            if(gp.getSelection() ==null)
                ...
                {
                    if(user[i][0].equals(answers[i][1]))
                    {
                        score+=10;
                    }
                    else
